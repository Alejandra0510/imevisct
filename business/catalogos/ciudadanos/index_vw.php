...
<html lang="en">
<head>
    <title> Ciudadanos | <?php echo $titulo_paginas?> </title>
                                                ...
                                                <tbody>
                                                    <?php 
                                                        while($row_reg = $rsRegShow->fetch(PDO::FETCH_OBJ)){
                                                            $id_ciudadano    = $row_reg->id_ciudadano;                
                                                            $id_colonia      = $row_reg->id_colonia;            
                                                            $id_calle        = $row_reg->id_calle;            
                                                            $id_municipio    = $row_reg->id_municipio;                
                                                            $nombre_completo = $row_reg->nombre_completo;                    
                                                            $numero_exterior = $row_reg->numero_exterior;                    
                                                            $numero_interior = $row_reg->numero_interior;                    
                                                            $cp              = $row_reg->cp;    
                                                            $telefono_fijo   = $row_reg->telefono_fijo;                
                                                            $telefono_cel    = $row_reg->telefono_cel;                
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    if($activo == 1){
                                                                        if($_SESSION[edit] == 1){
                                                                            ?>
                                                                            <a href="javascript:void(0)"
                                                                               onclick="openMyLink(1, <?php echo $id_ciudadano?>, '<?php echo $param.'ver&pag='.$pag.$fPaginacion?>')"
                                                                               class="btn ink-reaction btn-icon-toggle"
                                                                               data-toggle="tooltip"
                                                                               data-placement="top"
